...
\DoxyCodeLine{00014\ }
\DoxyCodeLine{00015\ \textcolor{preprocessor}{\#include\ "{}VICIITypes.h"{}}}
...
\DoxyCodeLine{00020\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{_memory_types_8h}{MemoryTypes.h}}"{}}}
...
\DoxyCodeLine{00451\ \ \ \ \ \mbox{\hyperlink{_memory_types_8h_adea0e9ad7389791d42ae1d396d68915a}{MemoryType}}\ memSrc[16];}
\DoxyCodeLine{00452\ \ \ \ \ }
...
\DoxyCodeLine{00610\ }
\DoxyCodeLine{00611\ \ \ \ \ \textcolor{keywordtype}{void}\ initFuncTable(VICIIRevision\ revision);}
\DoxyCodeLine{00612\ \ \ \ \ \textcolor{keywordtype}{void}\ initFuncTable(VICIIRevision\ revision,\ u16\ flags);}
\DoxyCodeLine{00613\ }
...
\DoxyCodeLine{00850\ \ \ \ \ \textcolor{keywordtype}{void}\ setRevision(VICIIRevision\ revision);}
\DoxyCodeLine{00851\ }
\DoxyCodeLine{00852\ \ \ \ \ }
...
\DoxyCodeLine{00864\ \ \ \ \ \textcolor{keyword}{static}\ \textcolor{keywordtype}{bool}\ delayedLightPenIrqs(VICIIRevision\ rev);}
...
\DoxyCodeLine{00868\ \ \ \ \ \textcolor{keyword}{static}\ \textcolor{keywordtype}{double}\ getFps(VICIIRevision\ rev);}
...
\DoxyCodeLine{00872\ \ \ \ \ \textcolor{keyword}{static}\ isize\ getFrequency(VICIIRevision\ rev);}
...
\DoxyCodeLine{00876\ \ \ \ \ \textcolor{keyword}{static}\ isize\ getCyclesPerLine(VICIIRevision\ rev);}
...
\DoxyCodeLine{00880\ \ \ \ \ \textcolor{keyword}{static}\ isize\ getLinesPerFrame(VICIIRevision\ rev);}
...
\DoxyCodeLine{00884\ \ \ \ \ \textcolor{keyword}{static}\ isize\ getCyclesPerFrame(VICIIRevision\ rev);}
...
\DoxyCodeLine{00888\ \ \ \ \ \textcolor{keyword}{static}\ isize\ numVisibleLines(VICIIRevision\ rev);}
...
\DoxyCodeLine{00892\ \ \ \ \ \textcolor{keyword}{static}\ \textcolor{keywordtype}{bool}\ hasGrayCodeBug(VICIIRevision\ rev);}
...
\DoxyCodeLine{00915\ \ \ \ \ u32\ getColor(isize\ nr,\ Palette\ palette);}
\DoxyCodeLine{00916\ }
...
\DoxyCodeLine{01416\ \ \ \ \ ScreenGeometry\ getScreenGeometry(\textcolor{keywordtype}{void})\ \textcolor{keyword}{const};}
\DoxyCodeLine{01417\ \ \ \ \ }
