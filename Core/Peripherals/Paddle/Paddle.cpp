...
Paddle::setPosXY(isize nr, double x, double y)
{
    ...
    switch (config.orientation) {
        ...
        case PaddleOrientation::HORIZONTAL:         pos[nr] = x; break;
        case PaddleOrientation::HORIZONTAL_FLIPPED: pos[nr] = x; break;
        case PaddleOrientation::VERTICAL:           pos[nr] = y; break;
        case PaddleOrientation::VERTICAL_FLIPPED:   pos[nr] = y; break;
