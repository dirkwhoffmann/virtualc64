    ...
    switch (opt) {
        ...
        case Opt::VICII_REVISION:
            ...
            if (!VICIIRevEnum::isValid(value)) {
                throw CoreError(CoreError::OPT_INV_ARG, VICIIRevEnum::keyList());
            }
            return;
        ...
        case Opt::GLUE_LOGIC:
            ...
            if (!GlueLogicEnum::isValid(value)) {
                throw CoreError(CoreError::OPT_INV_ARG, GlueLogicEnum::keyList());
            }
            return;
