 ...
 * the public API, two abstract classes are involed: AnyFile and AnyCollection.
 * AnyFiles provides basic functionality for reading and writing files, streams,
 * and buffers. AnyCollection provides an abstract interface for accessing
