...
<div style="display: flex"><svg  class="icon_btn" onclick="stop_emu_view();" xmlns="http://www.w3.org/2000/svg" width="2.0em" height="2.0em" fill="currentColor" class="bi bi-pause-btn" viewBox="0 0 16 16">
...
<a title="open fullwindow in new browser tab" style="margin-left:auto;border:none;width:1.5em;margin-top:4px" onclick="stop_emu_view();" href="https://dirkwhoffmann.github.io/virtualc64web/${params}#${address}" target="blank">
