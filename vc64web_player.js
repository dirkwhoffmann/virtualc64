...
<div style="display: flex;margin-top:-5px"><svg  class="icon_btn" onclick="stop_emu_view();" xmlns="http://www.w3.org/2000/svg" width="2.0em" height="2.0em" fill="currentColor" class="bi bi-pause-btn" viewBox="0 0 16 16">
...
<a style="margin-left:auto;border:none;width:1.1em" onclick="stop_emu_view();" href="https://dirkwhoffmann.github.io/virtualc64web/${params}#${address}" target="blank">
    <svg class="icon_btn" xmlns="http://www.w3.org/2000/svg" width="1.1em" height="1.1em" fill="currentColor" class="bi bi-pause-btn" viewBox="0 0 16 16">
