...
#include "rvconfig.h"
#include "Images/Encoders/DOSEncoder.h"
...
DOSEncoder::encodeTrack(utl::ByteView src, TrackNr t)
{
    ...
    logmsg(LOG_IMG, "Encoding DOS track %ld with %ld sectors\n", t, count);
    ...
    logmsg(LOG_IMG, "Track %ld checksum = %x\n", t, view.fnv32());
...
DOSEncoder::encodeSector(utl::MutableByteView track, isize offset, TrackNr t, SectorNr s, utl::ByteView data)
{
    ...
    logmsg(LOG_IMG, "Encoding sector %ld\n", s);
