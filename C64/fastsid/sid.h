...
struct sid_engine_s {
    ...
    void (*reset)(struct sound_s *psid, uint64_t cpu_clk);
    int (*calculate_samples)(struct sound_s *psid, int16_t *pbuf, int nr,
                             int interleave, int *delta_t);
    void (*prevent_clk_overflow)(struct sound_s *psid, uint64_t sub);
...
extern void sid_sound_machine_reset(sound_t *psid, uint64_t cpu_clk);
...
extern void sid_sound_machine_prevent_clk_overflow(sound_t *psid, uint64_t sub);
