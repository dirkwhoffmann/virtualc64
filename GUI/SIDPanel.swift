...
extension Inspector {
    ...
    func refreshSID(count: Int = 0, full: Bool = false) {
        ...
        if full {
            ...
            sidAttackRate1.assignFormatter(fmt8)
            sidDecayRate1.assignFormatter(fmt8)
            sidSustainRate1.assignFormatter(fmt8)
            sidReleaseRate1.assignFormatter(fmt8)

            sidFrequency2.assignFormatter(fmt16)
            sidPulseWidth2.assignFormatter(fmt12)
            sidAttackRate2.assignFormatter(fmt8)
            sidDecayRate2.assignFormatter(fmt8)
            sidSustainRate2.assignFormatter(fmt8)
            sidReleaseRate2.assignFormatter(fmt8)

            sidFrequency3.assignFormatter(fmt16)
            sidPulseWidth3.assignFormatter(fmt12)
            sidAttackRate3.assignFormatter(fmt8)
            sidDecayRate3.assignFormatter(fmt8)
            sidSustainRate3.assignFormatter(fmt8)
            sidReleaseRate3.assignFormatter(fmt8)
