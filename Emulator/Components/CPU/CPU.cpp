...
{
    if (debugger.breakpoints.isSetAt(addr)) throw Error(vc64::ERROR_BP_ALREADY_SET, addr);
...
{
    if (!debugger.breakpoints.guardNr(nr)) throw Error(vc64::ERROR_BP_NOT_FOUND, nr);
...
{
    if (!debugger.breakpoints.guardAt(addr)) throw Error(vc64::ERROR_BP_NOT_FOUND, addr);
...
{
    if (debugger.watchpoints.isSetAt(addr)) throw Error(vc64::ERROR_WP_ALREADY_SET, addr);
...
{
    if (!debugger.watchpoints.guardNr(nr)) throw Error(vc64::ERROR_WP_NOT_FOUND, nr);
...
{
    if (!debugger.watchpoints.guardAt(addr)) throw Error(vc64::ERROR_WP_NOT_FOUND, addr);
