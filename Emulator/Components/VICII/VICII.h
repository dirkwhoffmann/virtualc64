...
private:
     ...
     */
    u32 *emuTexture1 = new u32[Texture::TEX_HEIGHT * Texture::TEX_WIDTH];
    u32 *emuTexture2 = new u32[Texture::TEX_HEIGHT * Texture::TEX_WIDTH];
    u32 *dmaTexture1 = new u32[Texture::TEX_HEIGHT * Texture::TEX_WIDTH];
    u32 *dmaTexture2 = new u32[Texture::TEX_HEIGHT * Texture::TEX_WIDTH];
