...
C64Key::translate(char c)
{
    switch (c) {
        ...
        case '!': return std::vector { C64Key::digit1, C64Key::shift };
        case '2': return std::vector { C64Key::digit2 };
        case '"': return std::vector { C64Key::digit2, C64Key::shift };
        case '3': return std::vector { C64Key::digit3 };
        case '#': return std::vector { C64Key::digit3, C64Key::shift };
        case '4': return std::vector { C64Key::digit4 };
        case '$': return std::vector { C64Key::digit4, C64Key::shift };
        case '5': return std::vector { C64Key::digit5 };
        case '%': return std::vector { C64Key::digit5, C64Key::shift };
        case '6': return std::vector { C64Key::digit6 };
        case '&': return std::vector { C64Key::digit6, C64Key::shift };
        case '7': return std::vector { C64Key::digit7 };
        case '\'': return std::vector { C64Key::digit7, C64Key::shift };
        case '8': return std::vector { C64Key::digit8 };
        case '(': return std::vector { C64Key::digit8, C64Key::shift };
        case '9': return std::vector { C64Key::digit9 };
        case ')': return std::vector { C64Key::digit9, C64Key::shift };
        ...
        case 'Q': return std::vector { C64Key::Q, C64Key::shift };
        case 'w': return std::vector { C64Key::W };
        case 'W': return std::vector { C64Key::W, C64Key::shift };
        case 'e': return std::vector { C64Key::E };
        case 'E': return std::vector { C64Key::E, C64Key::shift };
        case 'r': return std::vector { C64Key::R };
        case 'R': return std::vector { C64Key::R, C64Key::shift };
        case 't': return std::vector { C64Key::T };
        case 'T': return std::vector { C64Key::T, C64Key::shift };
        case 'y': return std::vector { C64Key::Y };
        case 'Y': return std::vector { C64Key::Y, C64Key::shift };
        case 'u': return std::vector { C64Key::U };
        case 'U': return std::vector { C64Key::U, C64Key::shift };
        case 'i': return std::vector { C64Key::I };
        case 'I': return std::vector { C64Key::I, C64Key::shift };
        case 'o': return std::vector { C64Key::O };
        case 'O': return std::vector { C64Key::O, C64Key::shift };
        case 'p': return std::vector { C64Key::P };
        case 'P': return std::vector { C64Key::P, C64Key::shift };
        case '@': return std::vector { C64Key::at };
        case '*': return std::vector { C64Key::asterisk };
        
        case 'a': return std::vector { C64Key::A };
        case 'A': return std::vector { C64Key::A, C64Key::shift };
        case 's': return std::vector { C64Key::S };
        case 'S': return std::vector { C64Key::S, C64Key::shift };
        case 'd': return std::vector { C64Key::D };
        case 'D': return std::vector { C64Key::D, C64Key::shift };
        case 'f': return std::vector { C64Key::F };
        case 'F': return std::vector { C64Key::F, C64Key::shift };
        case 'g': return std::vector { C64Key::G };
        case 'G': return std::vector { C64Key::G, C64Key::shift };
        case 'h': return std::vector { C64Key::H };
        case 'H': return std::vector { C64Key::H, C64Key::shift };
        case 'j': return std::vector { C64Key::J };
        case 'J': return std::vector { C64Key::J, C64Key::shift };
        case 'k': return std::vector { C64Key::K };
        case 'K': return std::vector { C64Key::K, C64Key::shift };
        case 'l': return std::vector { C64Key::L };
        case 'L': return std::vector { C64Key::L, C64Key::shift };
        case ':': return std::vector { C64Key::colon };
        case '[': return std::vector { C64Key::colon, C64Key::shift };
        case ';': return std::vector { C64Key::semicolon };
        case ']': return std::vector { C64Key::semicolon, C64Key::shift };
        case '=': return std::vector { C64Key::equal };
        case '\n': return std::vector { C64Key::ret };
        
        case 'z': return std::vector { C64Key::Z };
        case 'Z': return std::vector { C64Key::Z, C64Key::shift };
        case 'x': return std::vector { C64Key::X };
        case 'X': return std::vector { C64Key::X, C64Key::shift };
        case 'c': return std::vector { C64Key::C };
        case 'C': return std::vector { C64Key::C, C64Key::shift };
        case 'v': return std::vector { C64Key::V };
        case 'V': return std::vector { C64Key::V, C64Key::shift };
        case 'b': return std::vector { C64Key::B };
        case 'B': return std::vector { C64Key::B, C64Key::shift };
        case 'n': return std::vector { C64Key::N };
        case 'N': return std::vector { C64Key::N, C64Key::shift };
        case 'm': return std::vector { C64Key::M };
        case 'M': return std::vector { C64Key::M, C64Key::shift };
        case ',': return std::vector { C64Key::comma };
        case '<': return std::vector { C64Key::comma, C64Key::shift };
        case '.': return std::vector { C64Key::period };
        case '>': return std::vector { C64Key::period, C64Key::shift };
        case '/': return std::vector { C64Key::slash };
        case '?': return std::vector { C64Key::slash, C64Key::shift };
