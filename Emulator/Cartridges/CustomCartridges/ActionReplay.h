...
public:
    ...
    const string getDescription() const override { return "AR3"; }
...
public:
    ...
    const string getDescription() const override { return "ActionReplay"; }
...
public:
    ...
    const string getDescription() const override { return "AtomicPower"; }
