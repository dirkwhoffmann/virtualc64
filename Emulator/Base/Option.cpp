...
OptionParser::create(Option opt, i64 arg)
{
    ...
    switch (opt) {
        ...
        case OPT_DASM_NUMBERS:              return enumParser.template operator()<DasmNumbersEnum,DasmNumbers>();
            
        case OPT_VICII_REVISION:            return enumParser.template operator()<VICIIRevisionEnum,VICIIRevision>();
        ...
        case OPT_GLUE_LOGIC:                return enumParser.template operator()<GlueLogicEnum,GlueLogic>();
        ...
        case OPT_USR_DEVICE:                return enumParser.template operator()<UserPortDeviceEnum,UserPortDevice>();
        ...
        case OPT_MON_UPSCALER:              return enumParser.template operator()<UpscalerEnum,Upscaler>();
        ...
        case OPT_MON_DOTMASK:               return enumParser.template operator()<DotmaskEnum,Dotmask>();
        case OPT_MON_DOTMASK_BRIGHTNESS:    return numParser();
        case OPT_MON_SCANLINES:             return enumParser.template operator()<ScanlinesEnum,Scanlines>();
        ...
        case OPT_POWER_GRID:                return enumParser.template operator()<PowerGridEnum,PowerGrid>();
        ...
        case OPT_SID_REVISION:              return enumParser.template operator()<SIDRevisionEnum,SIDRevision>();
        case OPT_SID_FILTER:                return boolParser();
        case OPT_SID_ENGINE:                return enumParser.template operator()<SIDEngineEnum,SIDEngine>();
        case OPT_SID_SAMPLING:              return enumParser.template operator()<SamplingMethodEnum,SamplingMethod>();
        ...
        case OPT_MEM_INIT_PATTERN:          return enumParser.template operator()<RamPatternEnum,RamPattern>();
        case OPT_MEM_HEATMAP:               return boolParser();
        case OPT_MEM_SAVE_ROMS:             return boolParser();

        case OPT_DRV_AUTO_CONFIG:           return boolParser();
        case OPT_DRV_TYPE:                  return enumParser.template operator()<DriveTypeEnum,DriveType>();
        case OPT_DRV_RAM:                   return enumParser.template operator()<DriveRamEnum,DriveRam>();
        case OPT_DRV_SAVE_ROMS:             return boolParser();
        case OPT_DRV_PARCABLE:              return enumParser.template operator()<ParCableTypeEnum,ParCableType>();
        ...
        case OPT_DAT_MODEL:                 return enumParser.template operator()<DatasetteModelEnum,DatasetteModel>();
        case OPT_DAT_CONNECT:               return boolParser();

        case OPT_MOUSE_MODEL:               return enumParser.template operator()<MouseModelEnum,MouseModel>();
        ...
        case OPT_PADDLE_ORIENTATION:        return enumParser.template operator()<PaddleOrientationEnum,PaddleOrientation>();

        case OPT_RS232_DEVICE:              return enumParser.template operator()<CommunicationDeviceEnum,CommunicationDevice>();
