    ...
    switch (opt) {
        ...
        case Opt::DRV_TYPE:
            ...
            if (!DriveTypeEnum::isValid(value)) {
                throw Error(Fault::OPT_INV_ARG, DriveTypeEnum::keyList());
            }
            return;
        ...
        case Opt::DRV_RAM:
            ...
            if (!DriveRamEnum::isValid(value)) {
                throw Error(Fault::OPT_INV_ARG, DriveRamEnum::keyList());
            }
            return;
        ...
        case Opt::DRV_PARCABLE:
            ...
            if (!ParCableTypeEnum::isValid(value)) {
                throw Error(Fault::OPT_INV_ARG, ParCableTypeEnum::keyList());
            }
            return;
        ...
        case Opt::DRV_CONNECT:
            ...
            if (value && !canConnect()) {
                throw Error(Fault::ROM_DRIVE_MISSING);
            }
            return;
